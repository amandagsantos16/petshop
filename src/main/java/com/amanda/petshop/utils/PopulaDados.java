package com.amanda.petshop.utils;
...
import com.amanda.petshop.domain.Raca;
import com.amanda.petshop.repository.CategoriaRepository;
import com.amanda.petshop.repository.EspecieRepository;
...
import com.amanda.petshop.domain.PagCartao;
import com.amanda.petshop.domain.PagDinheiro;
...
import com.amanda.petshop.repository.PagamentoRepository;
import com.amanda.petshop.repository.ServicoRepository;
import com.amanda.petshop.domain.Cliente;
import com.amanda.petshop.domain.Endereco;
import com.amanda.petshop.domain.Funcionario;
...
public class PopulaDados {
	...
	public void cadastrar() throws ParseException {
		...
		Pagamento pgt2 = new PagDinheiro(null, 100.00, SituacaoPagamento.PENDENTE, srv1, sdf.parse("02/09/2021 00:00"),
				null);
		srv1.setPagamento(pgt2);

		Pagamento pgt3 = new PagDinheiro(null, 75.00, SituacaoPagamento.QUITADO, srv3, sdf.parse("05/09/2021 16:30"),
				null);
